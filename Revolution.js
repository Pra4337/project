  ...
  return (
    <Grid container direction="column">
        ...
        <Grid item container direction="column" lg style={{ maxWidth: "40em" }}>
          ...
          <Grid item>
            ...
            >
              ...
              helping them overcome life is obstacles. Each project is a step
              towards that goal.
            </Typography>
          </Grid>
        </Grid>
        ...
        >
          ...
          <Grid item>
            ...
            <Typography
              ...
              paragraph
            >
              Then it is time for us to start on your minimum viable product.
              That is just a fancy term for a mockup, which doesn’t include
        ...
        >
          ...
          <Grid item>
            ...
            <Typography
              ...
              paragraph
            >
              Once you are completely satisfied with the vision for our solution
              we get down to the nitty gritty, fine-details of design.
            </Typography>
          </Grid>
        </Grid>
        <Grid item lg style={{ alignSelf: "center" }}>
          <img alt="magnifying glass" width="100%" />
        </Grid>
      </Grid>
      <Grid
        item
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              colors, and logos to extend the experience you are already familiar
              with.
            </Typography>
            <Typography
              variant="body1"
        ...
        >
          ...
          <Grid item>
            ...
            <Typography
              ...
              paragraph
            >
              This time we all be going over the finalized designs in another
        ...
        >
          ...
          <Grid item>
            ...
            <Typography
              ...
              paragraph
            >
              Finishing the application doesnot mean we are done though, because
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              We all give our final demonstration to show off your shiny new
            ...
            >
              ...
              out to the public. We are there to ensure everything goes to plan
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img  alt="falling dominoes" width="100%" />
        </Grid>
      </Grid>
      <Grid item>
